    ...
    <>
        ...
        <div className="shell relative py-28 md:py-36">
          <Reveal>
            <div className="eyebrow text-silver-200">
              ...
              Chicago · Business Growth &amp; Technology Agency
            </div>
          </Reveal>

          <Reveal delay={0.08}>
            <h1 className="mt-7 max-w-[18ch] text-display-xl font-bold leading-[1.02] tracking-tight text-gradient md:max-w-[22ch]">
              Growth systems for local business.
            </h1>
          </Reveal>

          <Reveal delay={0.16}>
            <p className="mt-8 max-w-[54ch] text-[17px] leading-relaxed text-silver-400">
              We build the websites, AI assistants, and follow-up systems that make sure a local
              business never loses another customer to a missed call or an unanswered message.
            </p>
          </Reveal>
      ...
      <section className="shell py-24 md:py-28">
        <Reveal>
          <SectionHeading
            eyebrow="What we do"
            title="Most local businesses don't have a marketing problem. They have a response problem."
            lede="A missed call at 4pm on a Friday is a customer who called the next shop on the list. We build the systems that answer, capture, and follow up automatically — so the work you already earned doesn't walk out the door."
          />
        </Reveal>
        ...
        <div className="shell">
          <Reveal>
            <SectionHeading
              ...
              lede="We build working demos on real local businesses before we ever pitch them — so you can see the system running, not a slide about it."
